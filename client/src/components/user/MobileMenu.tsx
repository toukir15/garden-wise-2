...
export default function MobileMenu() {
  ...
  return (
    <div className="visible xl:invisible flex justify-between px-4 xl:px-16 sticky -bottom-1 py-3 border-b-[0.5px] z-[50] border-gray-600 bg-[#19191C] backdrop-blur-md shadow-lg rounded-lg">
    <Link href={"/"} passHref>

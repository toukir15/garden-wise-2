...
const updateBookmark = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const bookmarkId = req.params.bookmarkId;
    const postId = req.body.postId;
    const result = yield bookmark_service_1.BookmarkServices.updateBookmarkIntoDB(bookmarkId, postId);

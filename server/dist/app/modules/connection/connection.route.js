...
router.get('/followers/:userId', (0, auth_1.default)(user_const_1.USER_ROLE.user, user_const_1.USER_ROLE.admin), connection_controller_1.ConnectionController.getViewProfileFollowers);
router.get('/followings/:userId', (0, auth_1.default)(user_const_1.USER_ROLE.user, user_const_1.USER_ROLE.admin), connection_controller_1.ConnectionController.getViewProfileFollowings);
